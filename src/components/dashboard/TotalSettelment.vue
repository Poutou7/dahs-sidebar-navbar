  ...
  <v-card elevation="10" class="bg-lightprimary overflow-hidden">
    <v-card-item>
      <div class="d-flex gap-3 align-center">
        ...
        <div>
          <span class="textPrimary">{{ $t('TotalSettlements') }}</span>
      ...
      <div>
        <div class="d-flex justify-space-evenly gap-4">
          <div class="pe-8">
            <p class="textPrimary mb-1">{{ $t('OnlinePaid') }}</p>
            <h3 class="text-h3 heading">$122,580</h3>
          </div>
          <div class="ps-8">
            <p class="textPrimary mb-1">{{ $t('CashierPaid') }}</p>
            <h3 class="text-h3 heading">$31,640</h3>
          </div>
          <div class="ps-8">
            <p class="textPrimary mb-1">{{ $t('Re-BookingRate') }}</p>
            <h3 class="text-h3 heading">18.4%</h3>
          </div>
          <div class="ps-8">
            <p class="textPrimary mb-1">{{ $t('EvaluationRate') }}</p>
            <h3 class="text-h3 heading">20.7%</h3>
          </div>
        </div>
      </div>
    </v-card-item>
