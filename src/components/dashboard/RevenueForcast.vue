...
const areaChart = {
  series: [
    {
      name: "2023",
      data: [50, 60, 30, 55, 75, 60, 100, 120, 52, 152, 200, 142],
    },

    {
      name: "2022",
      data: [35, 45, 40, 50, 35, 55, 40, 45, 142, 120, 60, 100],
    },
    {
      name: "2024",
      data: [100, 75, 80, 40, 20, 40, 0, 25, 20, 60, 158, 130],
    },
  ],
};
</script>
        ...
        <div class="d-flex gap-3 align-center">
          ...
          <div>
            ...
            <v-card-subtitle class="text-subtitle-1"
              >{{ $t("OverviewOfOrders") }}</v-card-subtitle
            >
          </div>
        </div>
